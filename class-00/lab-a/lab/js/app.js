...
let allProducts = []; // this had to be changed from a const to a let because it will need to be redefined later on as it will be converted to jSon and then pulled back out of local storage. 
...
function displayPics(){
  ...
  // This code was throwing an error because when we changed the keyword 'var' to 'const', the scope changed. When using the 'var' keyword, the scope of the keyword extended further outside of the code block into the entirety of the function. With the keyword 'let', it's scope only extends within the code block where it was established.
